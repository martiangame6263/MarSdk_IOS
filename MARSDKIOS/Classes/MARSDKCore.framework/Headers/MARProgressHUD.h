 ...
 * Apple's private UIProgressHUD class. The MARProgressHUD window spans over the
 ...
 * @attention MARProgressHUD is a UI class and should therefore only be accessed
 * on the main thread.
 */
...
/**
 * MARProgressHUD operation mode. The default is
 * MARProgressHUDModeIndeterminate.
 */
 ...
 * MARProgressMaxOffset and -MARProgressMaxOffset to move the HUD all the way to
 * the screen edge in each direction. E.g., CGPointMake(0.f,
 * MARProgressMaxOffset) would position the HUD centered on the bottom edge.
 */
 ...
 * accelerometer data. Has no effect on iOS < 7.0. Defaults to YES.
 */
 ...
 * MARProgressHUDModeCustomView. The view should implement intrinsicContentSize
 ...
 * Defaults to MARProgressHUDBackgroundStyleBlur on iOS 7 or later and
 * MARProgressHUDBackgroundStyleSolidColor otherwise.
...
- (void)showAnimated:(BOOL)animated
    whileExecutingBlock:(dispatch_block_t)block
        completionBlock:(nullable MARProgressHUDCompletionBlock)completion
...
@property (strong, nonatomic) UIColor *activityIndicatorColor
    __attribute__((deprecated("Use UIAppearance to customize UIActivityIndicatorView. E.g.: "
                              "[UIActivityIndicatorView "
                              "appearanceWhenContainedIn:[MARProgressHUD class], nil].color = "
                              "[UIColor redColor];")));
