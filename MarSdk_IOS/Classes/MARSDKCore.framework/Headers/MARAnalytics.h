...
/// 游戏角色相关事件
typedef NS_ENUM(NSInteger, UserOperateCode) { OP_CREATE_ROLE = 1, OP_ENTER_GAME, OP_LEVEL_UP, OP_EXIT };
...
// 额外获取虚拟币时，trigger 触发奖励的事件, 取值在 1~10
// 之间，“1”已经被预先定义为“系统奖励”， 2~10 需要在网站设置含义。
